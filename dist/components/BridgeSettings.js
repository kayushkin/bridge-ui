...
export function BridgeSettings() {
    ...
    const saveDefaults = useCallback(async (harness) => {
        ...
        if (defaults.permission_mode)
            cleaned.permission_mode = defaults.permission_mode;
