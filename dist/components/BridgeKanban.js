...
export function CardDetail({ card, boardID: _boardID, entityTypes, onClose, onPatch, onDelete, onAddLink, onDeleteLink, onOpenChat, onOpenInMail, mailBasePath, fetchFn, }) {
    const item = card.item;
...
function CardDrawer(props) {
    return (_jsx("div", { className: "bk-drawer-backdrop", onClick: props.onClose, children: _jsx("aside", { className: "bk-drawer", onClick: e => e.stopPropagation(), children: _jsx(CardDetail, { ...props }) }) }));
}
