...
const DEFAULT_PANES_HIDDEN = { turns: false, thread: true, timeline: true, git: true, kanban: true };
const DEFAULT_PANE_SIZES = { turns: 1, thread: 1, timeline: 1, git: 1, kanban: 1 };
...
function ensurePaneLeaves(node) {
    ...
    walk(node);
    const missing = ['turns', 'thread', 'timeline', 'git', 'kanban']
