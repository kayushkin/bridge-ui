...
export function itemCountOfTimelineBlock(block) {
 ...
 */
export function timelineWindowStart(blocks, itemBudget) {
...
export function itemsBeforeTimelineWindow(blocks, windowStart) {
 ...
 */
export function timelineBlockKey(block) {
    return block.kind === 'turn'
        ? `tg_${block.turnId}_${block.items[0]?.key ?? ''}`
        : `ti_${block.item.key}`;
}
//# sourceMappingURL=timelineWindow.js.map