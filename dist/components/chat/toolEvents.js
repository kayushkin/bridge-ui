...
function readIsError(entry) {
    if (entry.toolError !== undefined)
        return entry.toolError;
    const raw = entry.raw;
 ...
 */
export function toToolEvent(entry) {
    return {
 ...
 */
export function isToolRunning(entry, resulted) {
