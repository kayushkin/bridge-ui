...
export function toBridgeSessionInfo(info) {
    return {
...
export function toBridgeUsage(usage) {
...
export function isArchivedFolder(folderName) {
    return folderName === ARCHIVE_FOLDER || folderName === 'archive';
}
//# sourceMappingURL=bridgeAdapters.js.map