...
function SummaryCell({ result }) {
    ...
    return (_jsxs("span", { className: "cf-summary-text", children: [_jsx("span", { className: "cf-sum-pass", children: result.summary.passed }), result.summary.failed > 0 && _jsxs(_Fragment, { children: [" / ", _jsx("span", { className: "cf-sum-fail", children: result.summary.failed })] }), result.summary.unsupported > 0 && _jsxs(_Fragment, { children: [" / ", _jsx("span", { className: "cf-sum-unsup", children: result.summary.unsupported })] }), result.summary.skipped > 0 && _jsxs(_Fragment, { children: [" / ", _jsx("span", { className: "cf-sum-skip", children: result.summary.skipped })] })] }));
}
...
function CellBadge({ result, tested }) {
    ...
    if (result.unsupported)
        return _jsx("span", { className: "cf-badge cf-unsup", title: result.error, children: "No" });
    if (result.passed)
