...
export function BridgeProvider({ fetch: fetchFn, basePath = '/api/bridge', skillStoreBasePath = '', toolStoreBasePath = '', permissionStoreBasePath = '', kanbanStoreBasePath = '', bridgeAdapterBasePath = '', routes, children, }) {
