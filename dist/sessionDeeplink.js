...
export const initialSessionDeeplinkState = { applied: null, awaiting: null };
...
export function readSessionDeeplink(param, state) {
    if (!param || param === state.applied)
        return { open: null, state };
