...
export function isDeferrableEventType(type) {
    return type === 'stream';
}
export function createSSEEventBatcher(deliver, scheduler = animationFrameScheduler) {
    let buffered = [];
    let frame = null;
    const flush = () => {
        if (frame !== null) {
...
//# sourceMappingURL=sseEventBatching.js.map