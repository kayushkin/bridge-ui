...
export const DEFAULT_PANE_SIZES: PaneSizes = { turns: 1, thread: 1, timeline: 1, git: 1, kanban: 1, orchestrator: 1, attach: 1 }
...
export function saveFilterCollapsed(collapsed: boolean) {
  try { localStorage.setItem(FILTER_COLLAPSED_KEY, String(collapsed)) } catch { /* ignore */ }
}
...
export const saveExcludedStatuses = (s: Set<string>) => saveExcludedSet(STATUS_FILTER_KEY, s)
